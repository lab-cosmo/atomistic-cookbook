...
The MAD dataset combines "stable" inorganic structures from the MC3D dataset, 2D
structures from the MC2D dataset, and molecular crystals from the ShiftML dataset with
"Maximum Atomic Diversity" configurations, generated by distorting the composition and
structure of these stable templates. By doing so, PET-MAD achieves state-of-the-art
...
# structures from popular datasets (MPtrj, Alexandria, OC2020, SPICE, MD22) re-computed
