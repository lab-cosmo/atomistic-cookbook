...
2. **Training**: fine-tune the PET-MAD-XS foundational MLIP on a small water dataset
...
# ------------------------
#
# All data and model files are included in a single zip archive, which we download and
# extract:
